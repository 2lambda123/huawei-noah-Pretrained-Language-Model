...
def http_get(url, temp_file):
    ...
    This function sends an HTTP GET request to the specified URL and saves the response to the specified file.
...
def get_from_cache(url, cache_dir=None):
    ...
    Args:
        ...
        cache_dir (str?): The directory path for caching the dataset. If not provided, the default cache directory is used.

...
def set_seed(args):
    ...
    This function sets the random seed for the Python random, NumPy, and
    PyTorch libraries to ensure reproducibility of results.

    Args:
        args (argparse.Namespace): The input arguments containing the seed value.
    """
